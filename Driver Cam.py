...
root.title('Dozy Detection')
frame.config(background='light blue')
label = Label(frame, text="Dozy Detection",bg='light blue',font=('Times 35 bold'))
label.pack(side=TOP)
...
subm2.add_command(label="Driver Camera",command=anotherWin)
...
but2=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=webrec,text='Open Camera & Record',font=('helvetica 15 bold'))
but2.place(x=5,y=176)

but3=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=webdet,text='Open Camera & Detect',font=('helvetica 15 bold'))
...
but5=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=blink,text='Detect  dozy by Eye Blink With Sound',font=('helvetica 15 bold'))
